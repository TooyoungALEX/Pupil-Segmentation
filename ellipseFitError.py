...
def EllipseFitErrorUNet(input, target):
    ...
    for i in range(batchSize):
        ...
        noPixels = ellipseFitErrorDll.EllipseFitError(width, height, ctypes.c_void_p(img.ctypes.data),
                                                      ctypes.c_void_p(gt.ctypes.data),
                                                      ctypes.c_void_p(distances.ctypes.data))
